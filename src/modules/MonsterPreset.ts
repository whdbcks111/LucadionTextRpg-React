...
import { StatType, Time } from "./Internal";
import { Item } from "./Item";
import { LivingEntity } from "./LivingEntity";
import { Monster, MonsterTendency, MonsterType } from "./Monster";
import { Player } from "./Player";
import { Projectile } from "./Projectile";
import { Option } from "./Trigger";
...
export class MonsterPreset {
    static list: MonsterPresetObject[] = [
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    if (target) monster.attack(target, {
                        onHit: victim => {
                            if (Math.random() < 0.3)
                                victim.addEffect(new Effect(EffectType.BLOOD, 1, 10));
                        }
                    });
                }
            },
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    if (target) monster.attack(target, {
                        onHit: victim => {
                            if (Math.random() < 0.3)
                                victim.addEffect(new Effect(EffectType.BLOOD, 3, 10));
                            victim.addEffect(new Effect(EffectType.FROZEN, 15, 5));
                        }
                    });
                }
            },
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    if (target) monster.attack(target, {
                        onHit: victim => {
                            if (Math.random() < 0.9)
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 2, 20));
                        }
                    });
                }
            },
                    ...
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity) {
                                victim.addEffect(new Effect(EffectType.FROZEN, 6, 2));
                                if (isSkill) victim.addEffect(new Effect(EffectType.SILENCE, 1, 2));
                            }
                        },
                        owner: monster
                    });
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.3) victim.addEffect(new Effect(EffectType.BLOOD, 7, 4.5));
                            if (dash) {
                                victim.addEffect(new Effect(EffectType.STUN, 10, 0.7));
                                victim.addEffect(new Effect(EffectType.FROZEN, 10, 4.5));
                            }
                        },
                    };
                    if (dash) {
                        args.additionalMessage = '스노우 베어가 돌진했다!';
        ...
        {
            name: '마수 굴탄',
            types: [MonsterType.BEAST, MonsterType.BACK_WORLD],
            level: 771,
            gold: 0,
            attributes: {
                attack: '+500+20%',
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.5) victim.addEffect(new Effect(EffectType.BLOOD, 70, 4.5));
                            if (dash) {
                                victim.addEffect(new Effect(EffectType.DECREASE_HEAL_EFFICIENCY, 10, 10));
                                victim.addEffect(new Effect(EffectType.FIRE, 100, 6.5));
                            }
                        },
                    };
                    if (dash) {
                        args.additionalMessage = '굴탄이 뛰어올랐다!';
                        monster.attribute.multiplyValue(AttributeType.MOVE_SPEED, 2);
                    }
                    if (target) monster.attack(target, args);
                }
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 20, 4.5));
                            if (Math.random() < 0.4) {
                                victim.addEffect(new Effect(EffectType.DECREASE_HEAL_EFFICIENCY, 20, 10));
                                victim.addEffect(new Effect(EffectType.FIRE, 80, 7.5));
                            }
                        },
                    };
                    if (target) monster.attack(target, args);
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 50, 4.5));
                            if (Math.random() < 0.4) {
                                victim.addEffect(new Effect(EffectType.DECREASE_HEAL_EFFICIENCY, 50, 10));
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 30, 6.5));
                            }
                        },
                    };
                    if (target)
        ...
        },
        {
            name: '견습 마족',
            level: 851,
            types: [MonsterType.BACK_WORLD, MonsterType.HUMANOID],
            gold: 500,
            attributes: {
                attack: '+1000+20%',
                defend: '+10000',
                ...
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 20, 4.5));
                            if (Math.random() < 0.4) {
                                victim.addEffect(new Effect(EffectType.BIND, 1, 0.5));
                                victim.addEffect(new Effect(EffectType.FIRE, 150, 7.5));
                            }
                        },
                    };
                    if (Math.random() < 0.3)
                        args.additionalMessage = Utils.pick(['크윽... 죽어라!', '크앍!', '네 이놈!', '캬아아!']);
                    if (target) monster.attack(target, args);
                }
            },
            drops: [
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity) {
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 6, 2, self));
                                if (isSkill) victim.addEffect(new Effect(EffectType.CHARM, 1, 1, self));
                            }
                        },
                        owner: monster
                    });
                ...
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 20, 4.5));
                            if (Math.random() < 0.3) {
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 1, 0.6));
                                victim.addEffect(new Effect(EffectType.FIRE, 70, 7.5));
                            }
                        },
                    };
                    if (Math.random() < 0.3) args.additionalMessage = Utils.pick(['재로 돌아가라!', '쉬이이이!', '샤샤샤샥', '캬아아아아!']);
                    if (target) monster.attack(target, args);
                }
            },
            drops: [
                ...
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 20, 4.5));
                            if (Math.random() < 0.2) {
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 10, 3.6));
                                victim.addEffect(new Effect(EffectType.FIRE, 100, 7.5));
                            }
                        },
                    };
                    if (target) monster.attack(target, args);
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.7) victim.addEffect(new Effect(EffectType.BLOOD, 60, 4.5));
                            if (Math.random() < 0.2) {
                                victim.addEffect(new Effect(EffectType.STUN, 1, 1.6));
                                victim.addEffect(new Effect(EffectType.FIRE, 150, 7.5));
                            }
                        },
                    };
                ...
                if (monster.targets.size > 0
                    ...
                    let args: AttackOptions = {
                        onHit: victim => {
                            if (Math.random() < 0.3) victim.addEffect(new Effect(EffectType.BLOOD, 7, 4.5));
                            if (dash) {
                                victim.addEffect(new Effect(EffectType.STUN, 10, 0.4));
                                victim.addEffect(new Effect(EffectType.FROZEN, 10, 2.5));
                            }
                        },
                    };
                    if (dash) {
                        args.additionalMessage = '포스 스노우 베어가 돌진했다!';
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => Math.random() < 0.7 && victim.addEffect(new Effect(EffectType.SLOWNESS, 3, 7.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.AIRBORNE, 1, 0.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.FROZEN, 3, 20))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.STUN, 1, 0.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.FROZEN, 10, 7.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.FROZEN, 13, 7.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.FIRE && eff.level <= 10));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.NAUSEA, 1, 2.5))
                    });
                }
            },
            drops: [
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.FIRE && eff.level <= 5));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity)
                                victim.addEffect(new Effect(EffectType.FIRE, 1, 5));
                        },
                        owner: monster
                    });
                    if (target) projectile.attack(target, {
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.FIRE && eff.level <= 50));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity) {
                                victim.addEffect(new Effect(EffectType.FIRE, 100, 7));
                                victim.addEffect(new Effect(EffectType.DECAY, 50, 7));
                            }
                        },
                        owner: monster
                    });
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0
                    ...
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity) {
                                victim.addEffect(new Effect(EffectType.FIRE, 3, 8));
                                victim.addEffect(new Effect(EffectType.SLOWNESS, 2, 10));
                            }
                        },
                        owner: monster
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.FROZEN && eff.level <= 10));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity) {
                                victim.addEffect(new Effect(EffectType.FROZEN, 3, 10));
                                victim.addEffect(new Effect(EffectType.BLOOD, 1, 5));
                            }
                        },
                        owner: monster
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.FROZEN && eff.level <= 3));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity && Math.random() < 0.4) {
                                victim.addEffect(new Effect(EffectType.FROZEN, 1, 5));
                            }
                        },
                        owner: monster
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !(eff.type === EffectType.POISON && eff.level <= 30));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity && Math.random() < 0.6) {
                                victim.addEffect(new Effect(EffectType.POISON, 10, 30));
                            }
                        },
                        owner: monster
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                monster.effects = monster.effects.filter(eff => !([EffectType.POISON, EffectType.DECAY].includes(eff.type) && eff.level <= 50));
                if (monster.targets.size > 0
                    && monster.isAttackEnded()) {
                    let target = monster.target;
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity && Math.random() < 0.7) {
                                victim.addEffect(new Effect(EffectType.DECAY, 20, 15));
                            }
                        },
                        owner: monster
                    });
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0
                    ...
                    let projectile = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity && Math.random() < 0.7) {
                                victim.addEffect(new Effect(EffectType.POISON, 10, 50));
                                victim.addEffect(new Effect(EffectType.DECREASE_HEAL_EFFICIENCY, 5, 30));
                            }
                        },
                        owner: monster
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0
                    ...
                    let target = monster.target;
                    if (target) monster.attack(target, {
                        onHit: victim => victim.addEffect(new Effect(EffectType.FROZEN, 5, 10))
                    });
                }
            },
            drops: [
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0 && Date.now() - monster.extras.latestPoisonShot > 1000 * 15) {
                    ...
                    let poison = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity)
                                victim.addEffect(new Effect(EffectType.POISON, 6, 15));
                        }
                    });
                ...
                if (monster.life < monster.maxLife * 0.3 && !monster.extras.usedCC) {
                    ...
                    Player.sendGroupMessage(<Player[]>Array.from(monster.targets).filter(p => p instanceof Player), '[ 거미 여왕이 공포스러운 시선으로 바라봅니다! ]');
                }
                if (monster.targets.size > 0 && Date.now() - monster.extras.latestSpawnSpider > 1000 * 30
                    ...
                    let seen = new Set();
                    Player.sendGroupMessage(<Player[]>Array.from(monster.targets)
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0 && Date.now() - monster.extras.latestPoisonShot > 1000 * 8) {
                    ...
                    let poison = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity)
                                victim.addEffect(new Effect(EffectType.POISON, 40, 9));
                        }
                    });
                ...
                if (monster.life < monster.maxLife * 0.3 && !monster.extras.usedCC) {
                    ...
                    Player.sendGroupMessage(<Player[]>Array.from(monster.targets).filter(p => p instanceof Player), '[ 아닐레트가 탈피합니다..! 그 역겹고 공포스러운 모습에 모두 충격에 빠집니다! ]');
                }
                if (monster.extras.usedCC && monster.targets.size > 0 && Date.now() - monster.extras.latestSpawn > 1000 * 30) {
                    ...
                    Player.sendGroupMessage(players, '[ 아닐레트가 구역질을 하며 몸의 일부가 썩어들어가며 터집니다..! ]\n' +
        ...
        },
        {
            ...
            level: 666,
            regenTime: 60 * 5,
            types: [MonsterType.FIRE, MonsterType.BEAST, MonsterType.BACK_WORLD],
            tendency: MonsterTendency.HOSTILE,
            attributes: {
                attack: '+40%',
            ...
            onUpdate: monster => {
                ...
                if (monster.targets.size > 0
                    ...
                    if (target) monster.attack(target, {
                        onHit: victim => {
                            victim.addEffect(new Effect(EffectType.BLOOD, 25, 5));
                        }
                    });
                }
                if (monster.targets.size > 0 && Date.now() - monster.extras.latestShot > 1000 * 9) {
                    let target = monster.target;
                    let pr = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity)
                                victim.addEffect(new Effect(EffectType.FIRE, 40, 9));
                        }
                    });
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.getLocation() && monster.hasEffect(EffectType.OVERMASTER)) {
                    ...
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 다크나이트 로드가 마에서 끌어온 힘에 의해 제압에서 풀려났습니다! ]\n' +
                ...
                if (monster.getLocation() && monster.life < monster.maxLife * 0.5 && monster.extras.phase === 1 && monster.getLocation().objects.filter(s => s.name === '블러드 크리스탈').some(s => s.isAlive)) {
                    ...
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ ㄴ..ㅏ는 죽...지 않는다...! ]\n' +
                ...
                if (monster.getLocation() && monster.extras.fire > 0) {
                    ...
                    if (monster.extras.fire <= 0) {
                        let players = monster.getLocation().getPlayers(true);
                        Player.sendGroupMessage(players, '[ 이만 죽ㅇㅓ라..! ]\n' +
                    ...
                    if (Math.random() < 0.3) {
                        ...
                        let projectile = new Projectile({
                            ...
                            onHit: (projectile, victim) => {
                                if (victim instanceof LivingEntity) {
                                    if (isSkill) {
                                        victim.addEffect(new Effect(EffectType.SILENCE, 1, 3));
                                        victim.addEffect(new Effect(EffectType.STUN, 1, 1));
                                    }
                                    victim.addEffect(new Effect(EffectType.DECREASE_DEFEND, 7, 5));
                                }
                            },
                            owner: monster
                        });
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.getLocation() && !monster.extras.overmaster && monster.targets.size > 0 && monster.currentTarget) {
                    ...
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 저주받은 마법사가 스킬 [ 지배자의 눈 ] 을 사용했다! ]\n' +
                ...
                if (monster.getLocation() && monster.life < monster.maxLife * 0.35 && monster.extras.phase === 0) {
                    ...
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 저주받은 마법사가 폭주하기 시작합니다! ]');
                    players.forEach(p => {
                    ...
                    switch (monster.extras.magicCount %= 3) {
                        case 0:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity)
                                        victim.addEffect(new Effect(EffectType.FROZEN, 5, 5, monster));
                                }
                            });
                            if (target) projectile.attack(target, {
                                isMagicAttack: true,
                        ...
                        case 1:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.BLOOD, 13, 7, monster));
                                        victim.addEffect(new Effect(EffectType.SILENCE, 3, 6.5, monster));
                                    }
                                }
                            });
                            if (target) projectile.attack(target, {
                        ...
                        case 2:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.FIRE, 5, 6, monster));
                                        victim.addEffect(new Effect(EffectType.STUN, 3, 2, monster));
                                    }
                                }
                            });
                            players.forEach(p => {
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.getLocation() && !monster.extras.overmaster && monster.targets.size > 0 && monster.currentTarget) {
                    monster.extras.overmaster = Date.now();
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 카르쉬가 스킬 [ 지배자의 눈 ] 을 사용했다! ]\n' +
                ...
                if (monster.getLocation() && monster.life < monster.maxLife * 0.5 && monster.extras.phase === 0) {
                    ...
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 카르쉬가 점점 더 얼어붙기 시작합니다! ]');
                    players.forEach(p => {
                    ...
                    switch (monster.extras.magicCount %= 3) {
                        case 0:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity)
                                        victim.addEffect(new Effect(EffectType.FROZEN, 10, 5, monster));
                                }
                            });
                            if (target) projectile.attack(target, {
                                isMagicAttack: true,
                        ...
                        case 1:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.FROZEN, 13, 7, monster));
                                        victim.addEffect(new Effect(EffectType.STUN, 1, 2, monster));
                                    }
                                }
                            });
                            if (target) projectile.attack(target, {
                        ...
                        case 2:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.FROZEN, 1, 100, monster));
                                        victim.addEffect(new Effect(EffectType.SLOWNESS, 2, 10, monster));
                                    }
                                }
                            });
                            players.forEach(p => {
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.getLocation() && monster.life < monster.maxLife * 0.25 && monster.extras.phase === 0) {
                    ...
                    monster.stat.addStat(StatType.SPELL, 50);
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 마그마 큐빅이 불을 뿜어대며 폭주하기 시작합니다! ]');
                    players.forEach(p => {
                    ...
                    switch (monster.extras.magicCount %= 3) {
                        case 0:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.BIND, 1, 3, monster));
                                        victim.addEffect(new Effect(EffectType.FIRE, 5, 10, monster));
                                    }
                                }
                            });
                            if (target) projectile.attack(target, {
                        ...
                        case 1:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.SLOWNESS, 10, 6, monster));
                                        victim.addEffect(new Effect(EffectType.FIRE, 5, 4.5, monster));
                                    }
                                }
                            });
                            if (target) projectile.attack(target, {
                        ...
                        case 2:
                            projectile = new Projectile({
                                ...
                                onHit: (projectile, victim) => {
                                    if (victim instanceof LivingEntity) {
                                        victim.addEffect(new Effect(EffectType.FIRE, 2, 60, monster));
                                        victim.addEffect(new Effect(EffectType.STUN, 3, 1.5, monster));
                                    }
                                }
                            });
                            players.forEach(p => {
        ...
        },
        {
            ...
            onUpdate: monster => {
                ...
                if (monster.getLocation() && monster.hasEffect(EffectType.OVERMASTER)) {
                    monster.removeEffect(EffectType.OVERMASTER);
                    let players = monster.getLocation().getPlayers(true);
                    Player.sendGroupMessage(players, '[ 아를렌이 영혼화하여 제압에서 풀려났습니다! ]');
                    monster.extras.incAtk = true;
                }
                        ...
                        if (monster.getLocation() && monster.targets.size > 0) {
                            ...
                            switch (monster.extras.pattern %= 3) {
                                case 0:
                                    if (target) monster.attack(target, {
                                        onHit: victim => {
                                            victim.addEffect(new Effect(EffectType.BLOOD, 15, 4));
                                            victim.addEffect(new Effect(EffectType.SLOWNESS, 3, 4));
                                        },
                                        additionalMessage: '아를렌이 도끼를 가로로 휘둘렀다!'
                                    });
                                ...
                                case 1:
                                    ...
                                    if (players.length) players.forEach(p => {
                                        monster.attack(p, {
                                            onHit: victim => {
                                                victim.addEffect(new Effect(EffectType.BLOOD, 1, 30));
                                                victim.addEffect(new Effect(EffectType.SLOWNESS, 10, 5));
                                            },
                                            additionalMessage: '아를렌이 도끼를 회전하면서 주변을 베었다!'
                                        });
                                    });
                                    monster.extras.waitTime = 2;
                                    break;
                                case 2:
                                    if (target) {
                                        ...
                                        monster.attack(target, {
                                            absoluteHit: true,
                                            onHit: victim => {
                                                victim.addEffect(new Effect(EffectType.SLOWNESS, 11, 8));
                                                victim.addEffect(new Effect(EffectType.FEAR, 8, 6));
                                            },
                                            additionalMessage: '아를렌이 도끼를 내려찍었다. 아를렌은 무방비 상태인것 같다!'
                                        });
            ...
            onUpdate: monster => {
                if (monster.targets.size > 0
                    ...
                    let poison = new Projectile({
                        ...
                        onHit: (projectile, victim) => {
                            if (victim instanceof LivingEntity)
                                victim.addEffect(new Effect(EffectType.POISON, 3, 35));
                        }
                    });
                    if (target) poison.attack(target, {
                        isMagicAttack: true,
