import { NullableString, ResourcePresetObject } from "../types";
import { Time, ResourcePreset, AttributeType, Entity, DropItem, StatType } from "./Internal"
...
export class Resource extends Entity {
    ...
    rewardPlayer(player: Player): void {
        ...
        player.sendMessage(`[ ${this.getName()}(을)를 파괴하셨습니다! ]\n` +
            `▌ 보상\n` +
