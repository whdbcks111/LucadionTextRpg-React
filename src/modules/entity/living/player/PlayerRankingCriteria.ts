import { AttributeType, Player, PlayerLog } from "../../../Internal"
...
export class PlayerRankingCriteria {
    ...
    static list = [
        ...
        new PlayerRankingCriteria('카르마',
            p => p.karma,
            (p, score) => '카르마 ‣ ' + score.toFixed(1)
        ),
        new PlayerRankingCriteria('살인',
            p => p.log.getLog(PlayerLog.KILLED_PLAYER_COUNT),
            (p, score) => '살인 ‣ ' + score.toFixed(0)
        ),
